...
def train(configs, snapshot_path):
    ...
    db_chrisi_test = chrisi_dataset(configs.chrisi_cells_root_path, ['test_labelled'],
                                    configs.val_detections_transforms,cache_labels=True,blob_detection=False)
    ...
    weak_label_chrisi_dataset = chrisi_dataset(configs.chrisi_cells_root_path, ['alive', 'dead','inhib'],
                                               ...
                                               cache_labels=True,need_seam_less_clone=configs.need_seam_less_clone,blob_detection=False)
    ...
    for epoch_num in iterator:
        ...
        train_one_epoch(configs, weak_label_chrisi_dataloader, epoch_num, 20,
...
if __name__ == "__main__":
    ...
    configs = Configs('./configs/mask_rcnn_label_corr.ini')
